...
public class Science_situationController {
	@Autowired
	private IScience_situationBiz science_situationBiz;
	...
	public List<Map<String, Object>> recommendForRank(String mno) {
		...
		if (StringUtil.checkNull(weightInfo.getLocation(), weightInfo.getMajor())) { // 如果用户还未设置权重,直接return
			...
			// 采用地域优先算法
			list = science_situationBiz.locationRank(map); // 查出所有符合地域条件的学校
			// 所有的省会城市
			...
			// 采用专业优先算法
			list = science_situationBiz.majorRank(map); // 查出所有符合专业条件的学校
			// 所有的省会城市
			String city = "北京市天津市上海市重庆市石家庄市太原市呼和浩特市沈阳市长春市哈尔滨市南京市杭州市合肥市福州市南昌市济南市郑州市武汉市长沙市广州市南宁市海口市成都市贵阳市昆明市拉萨市西安市兰州市西宁市银川市乌鲁木齐市台北市";
			...
			// 采用学校优先算法
			list = science_situationBiz.schoolRank(map); // 查出所有符合专业条件的学校
			// 所有的省会城市
			String city = "北京市天津市上海市重庆市石家庄市太原市呼和浩特市沈阳市长春市哈尔滨市南京市杭州市合肥市福州市南昌市济南市郑州市武汉市长沙市广州市南宁市海口市成都市贵阳市昆明市拉萨市西安市兰州市西宁市银川市乌鲁木齐市台北市";
