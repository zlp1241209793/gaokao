...
/**
 *  MD5加密
 *  此类只能将明码加密后的字符串只有16位，如有更高要求的必要，可自行修改算法（只需�?部修改）即可
 */
public class MD5Encryption {  
	// 十六进制下数字到字符的映射数�?  
	private static String[] hexDigits = new String[]{"0", "f", "2", "e", "4", "a", "6", "d", "3", "9", "5", "8", "c", "7", "b", "1"};	 // 乱序，更�?

	/**
	 *  明码加密  
	 * @param plainCode 输入的明�?
